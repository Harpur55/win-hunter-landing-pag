        ...
        <div
            ...
            <div class="flex flex-col md:flex-row justify-between md:items-center gap-4">
                ...
                <div class="flex-1 text-center md:text-left">
                    <h2
                        class="text-xl sm:text-2xl font-bold flex flex-col sm:flex-row items-center justify-center md:justify-start gap-1 sm:gap-2 text-gray-900 dark:text-gray-100">
                        👋
                    ...
                    <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1 pl-4">
                        Kelas:
