    ...
    <x-filament::section>
        <div
            class="relative overflow-hidden rounded-2xl 
                   ...
                   shadow-[inset_1px_1px_0px_rgba(255,255,255,0.6),_inset_-2px_-2px_6px_rgba(0,0,0,0.05)]
        ...
        >
            ...
            <div class="flex flex-col md:flex-row justify-between md:items-center gap-4">
                ...
                <div
                    class="relative border border-gray-200 dark:border-gray-700 
                           ...
                           rounded-xl p-3 sm:p-4 w-full sm:w-32 text-center 
                           shadow-[3px_3px_8px_rgba(0,0,0,0.1),_-3px_-3px_8px_rgba(255,255,255,0.5)]
                ...
                >
                    <div class="text-3xl mb-1 animate-pulse">🥋</div>
            ...
            {{-- 💬 Pesan motivasi --}}
            <div class="mt-4 text-center md:text-left text-sm text-gray-700 dark:text-gray-400 leading-relaxed italic">
