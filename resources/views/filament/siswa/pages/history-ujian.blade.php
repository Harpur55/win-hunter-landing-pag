                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach ($riwayat as $index => $event)
                            ...
                            @endphp
                            <tr>
                                <td class="px-6 py-4 text-sm text-black dark:text-gray-300">{{ $index + 1 }}</td>
                                ...
                                <td class="px-6 py-4 text-sm text-black dark:text-gray-300">{{ $pivot->current_belt_level ?? '-' }}</td>
                                <td class="px-6 py-4 text-sm text-black dark:text-gray-300">{{ $pivot->next_belt_level ?? '-' }}</td>
                                <td class="px-6 py-4">
