...
<body class="font-sans">
  ...
  <ul id="mobile-menu-list" class="flex flex-col px-6 text-white text-lg">
    ...
    <li class="border-b border-white py-3"><a href="#" class="hover:text-gray-200">tentang Kami</a></li>
    <li class="border-b border-white py-3"><a href="#" class="hover:text-gray-200">Pelatih</a></li>
    <li class="border-b border-white py-3"><a href="#" class="hover:text-gray-200">Jadwal Latihan</a></li>
    <li class="border-b border-white py-3"><a href="#" class="hover:text-gray-200">Kontak & Alamat</a></li>
  </ul>
</div>
    ...
    <!-- Menu -->
     <div class="hidden md:block">
      <ul class="flex space-x-6 text-lg font-sans font-semibold">
        ...
        <li><a href="#" class="text-white hover:text-gray-200">Tentang Kami</a></li>
        <li><a href="#" class="text-white hover:text-gray-200">Pelatih</a></li>
        <li><a href="#" class="text-white hover:text-gray-200">Jadwal Latihan</a></li>
        <li><a href="#" class="text-white hover:text-gray-200">Kontak & Alamat</a></li>
      </ul>
    </div> 
  </div>
...
<div id="mobile-menu"
 ...
 <section class="bg-blue-700 py-10 px-6 md:px-20">
  <div class="container mx-auto flex flex-col-reverse md:flex-row items-center md:h-screen">
    ...
    <div class="w-full md:w-1/2 text-center md:text-left mt-6 md:mt-0 pt-6 md:pt-0">
      ...
      <p class="text-2xl md:text-4xl text-white mb-6">
...
<section id="service" class="bg-gray-100 py-10 px-4 sm:px-6 lg:px-20">
  ...
  $class = [
    [
        'name' => 'Kelas Prestasi',
        'image' => 'download.jpg',
        'deskripsi' => "1. Mengikuti Kejuaraan Nasional Dan Internasional\n" .
                       "2. Mengikuti Kejuaraan Daerah Dan Provinsi\n" .
                       "3. Latihan 4-5 Kali Dalam Seminggu\n" .
                       "4. Mengikuti Ujian Kenaikan Sabuk\n" .
                       "5. Mengikuti Latihan Poomsae",
    ],
    [
        'name' => 'Kelas Khusus',
        'image' => 'download.jpg',
...
"
      ...
      <div class="text-center lg:text-left">
        ...
        <p class="mt-2 text-sm text-blue-500"><a href="http://tiktok.com/@winhunterteam">@winhunterteam</p></a>
      </div>
    </div>
