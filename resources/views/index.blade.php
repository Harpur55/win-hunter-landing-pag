...
<body class="font-sans scroll-smooth">
    ...
    <div id="galleryModal"
        ...
        <section id="about-us" class="relative bg-gradient-to-b from-blue-50 to-white py-16 sm:py-20">
            <div
                class="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-blue-600/40 to-transparent pointer-events-none">
            </div>
                ...
                <div class="w-full max-w-6xl px-2 sm:px-4 mb-6 hidden lg:grid grid-cols-5 gap-6">
                    @foreach ($coaches as $coach)
                        ...
                        <div
                            ...
                            <p
                                class="text-emerald-600 font-semibold mb-2 px-3 py-0.5 bg-emerald-100 rounded-full text-xs">
                                {{ $coach->sabuk }}
                            </p>
        ...
        <section id="service" class="bg-gray-100 py-10 px-4 sm:px-6 lg:px-20">
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 my-6 text-center">
                ...
                <h2 class="text-4xl font-extrabold text-green-600">Rp 550.000 <span
                        class="text-gray-600 text-lg">(Sudah
        ...
        <section class="bg-gradient-to-br from-emerald-50 to-yellow-100 mt-4
    " id="contact">
            <div class="container px-6 py-12 mx-auto">
                ...
                <div class="flex flex-col lg:flex-row justify-center items-center gap-12 mt-10">
                    ...
                    <div class="text-center lg:text-left">
                        {{-- Icon phone kecil --}}
                        <span
                            class="inline-flex items-center justify-center p-2 rounded-full bg-blue-100 text-blue-600">
                        ...
                        <a href="https://wa.me/6285890810081?text=Halo..." target="_blank"
          ...
          hover:bg-green-600 transition">
                ...
                <!-- Maps Section -->
                <div class="mt-16">
                    <h2 class="text-3xl text-black text-center font-extrabold sm:text-4xl mb-4">Maps Lokasi Latihan
                    </h2>
                    <div class="w-full flex justify-center">
                        <iframe class="w-full lg:w-[75%] h-96 rounded-lg" frameborder="0" title="map"
                            scrolling="no"
