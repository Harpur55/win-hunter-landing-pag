    ...
    fetch("{{ route('siswa.search') }}?nama=" + encodeURIComponent(nama))
        ...
        .then(res => {
            ...
            document.querySelector('[name="tempat_lahir"]').value = s.tempat_lahir ?? '';
             document.querySelector('[name="tanggal_lahir"]').value  = s.tanggal_lahir ?? '';            document.querySelector('[name="alamat_lengkap"]').value = s.alamat_lengkap ?? '';
            ...
            document.querySelector('[name="units_id"]').value = s.units_id ?? '';
            document.querySelector('[name="kelas_id"]').value = s.kelas_id ?? '';
            document.querySelector('[name="beladiri_yang_pernah_diikuti"]').value = s.beladiri_yang_pernah_diikuti ?? '';
